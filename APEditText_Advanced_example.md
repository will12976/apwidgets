...
APEditText textField, numbersField, textField2, phoneNumberField;
...
void setup() {
  ...
  numbersField = new APEditText(width/2, 50, width/2, 50 );
  ...
  textField2 = new APEditText( 0, 150, width/2, 50 );
  ...
  phoneNumberField = new APEditText( width/2, 150, width/2, 50 );
