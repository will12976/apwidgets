...
![http://www.lundstedt.biz/apwidgets/images/PButtonExample.jpg](http://www.lundstedt.biz/apwidgets/images/PButtonExample.jpg)
...
void setup(){
  ...
  button1 = new APButton(10, 10, "Smaller"); //create new button from x- and y-pos. and label. size determined by text content
